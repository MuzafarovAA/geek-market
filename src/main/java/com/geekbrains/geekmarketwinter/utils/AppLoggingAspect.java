...
public class AppLoggingAspect {
    ...
    @Before("execution(public * com.geekbrains.geekmarketwinter.services.ShoppingCartService.addToCart(..)) && args(*, productId, ..)")
    ...
    @Before("execution(public * com.geekbrains.geekmarketwinter.services.ProductService.saveProduct(..)) && args(product)")
